...
function calculateBasket(){
  ...
  for(const productID in basket){
    ...
    let rowHTML = `<td style="max-width:10px;"><button id="${productID}" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="Remove product(s)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
