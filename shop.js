...
<div class="productBasketDiv"><button class="addToBasket btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket" viewBox="0 0 16 16">
...
<div class="adjustDiv"><button class="btn adjustDown btn btn-primary">-</button>
<input class="buyInput" data-num="[EVEGPRODUCT#]" min="0" value="0" type="number">
<button class="btn adjustUp btn btn-primary">+</button></div></div></div></div></div>`;
